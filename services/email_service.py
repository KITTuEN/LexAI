...
class EmailService:
    ...
    def send_otp_email(self, receiver_email, otp):
        try:
            msg = MIMEMultipart()
            msg['From'] = f"NyayaVyavasth Support <{self.smtp_sender}>"
            msg['To'] = receiver_email
            msg['Subject'] = "Your NyayaVyavasth Verification Code"
            ...
            <html>
                <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
                    <div style="background-color: #ffffff; padding: 40px; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); max-width: 500px; margin: 0 auto;">
                        <h2 style="color: #B8860B; text-align: center;">NyayaVyavasth Verification</h2>
                        <p style="font-size: 16px; color: #333;">Welcome to NyayaVyavasth. Use the following 6-digit code to verify your account:</p>
                        ...
                        <p style="font-size: 12px; color: #999; text-align: center;">&copy; 2026 NyayaVyavasth - Indian Legal Empowerment</p>
                    </div>
                </body>
            </html>
            """
